...
class TestChallengeBinaryNode:
    ...
    def test_roots(self):
        cs = ChallengeSet.create(name="foo")
        cbn1 = ChallengeBinaryNode.create(name="root1", cs=cs, blob="data", sha256="sum1")
        cbn2 = ChallengeBinaryNode.create(name="root2", cs=cs, blob="data", sha256="sum2")
        cbn3 = ChallengeBinaryNode.create(name="child", cs=cs, blob="data", root=cbn1, sha256="sum3")
    ...
    def test_unsubmitted_patches(self):
        cs = ChallengeSet.create(name="foo")
        cbn = ChallengeBinaryNode.create(name="cbn", cs=cs, blob="data", sha256="sum1")
        patch1 = ChallengeBinaryNode.create(name="patch1", cs=cs, blob="data", root=cbn, sha256="sum2")
        patch2 = ChallengeBinaryNode.create(name="patch2", cs=cs, blob="data", root=cbn, sha256="sum3")
    ...
    def test_found_crash_for_cb(self):
        cs = ChallengeSet.create(name="foo")
        cbn1 = ChallengeBinaryNode.create(name="cbn1", cs=cs, blob="data", sha256="sum1")
        cbn2 = ChallengeBinaryNode.create(name="cbn2", cs=cs, blob="data", sha256="sum2")
